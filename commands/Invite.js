...
module.exports.run = async (client, message, args) => {
    message.reply(`You said: "${args.join(" If you want to invite this bot to you own server copy and paste this link into you're browser :https://discord.com/oauth2/authorize?client_id=742662140078325851&permissions=8&scope=bot: ")}"`); //This will have the bot respond with whatever you placed in the arguments, for example, if you said 'examplecommand hello', the bot will say 'You said: "hello"'
